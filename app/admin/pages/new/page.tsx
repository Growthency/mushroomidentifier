        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="rounded-xl border p-4" style={{ background: '#1e293b', borderColor: '#334155' }}>
            ...
            <textarea
              ...
              placeholder="Write your article content here… (supports HTML and Markdown)"
              rows={24}
            ...
            <p className="text-xs text-slate-500 mt-2">
              Tip: Use HTML tags for rich formatting. Insert images with the button above.
            </p>
          </div>
        </div>
