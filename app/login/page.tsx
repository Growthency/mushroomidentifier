    ...
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: 'var(--bg-primary)' }}>
      <div className="w-full max-w-md">
        ...
        <div className="p-8 rounded-xl" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
          ...
          {error && (
            <div className="p-3 rounded-lg text-sm mb-5" style={{ background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444' }}>
              {error}
            </div>
          )}
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs font-medium" style={{ color: 'var(--text-faint)' }}>or sign in with email</span>
            <div className="flex-1 h-px" style={{ background: 'var(--border)' }} />
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              ...
              className="w-full px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity disabled:opacity-60"
